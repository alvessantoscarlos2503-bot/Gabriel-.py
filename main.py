...
resposta_autorizacao +input("Possui autorização do responsável? (s/n): ") .strip()

ingresso = resposta_ingresso in ("s", "sim")
autotorizacao = resposta_autorizacao in ("s", "sim")
